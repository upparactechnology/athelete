...
export class ClientController {
    ...
    static async initiateWalletPayment(req, res, next) {
        try {
    ...
    static async verifyWalletPayment(req, res, next) {
        try {
            const userId = req.user?.id;
    ...
    static async bulkDeleteSlots(req, res, next) {
        try {
            const { venueId } = req.params;
    ...
    static async reportProblem(req, res, next) {
        try {
            const userId = req.user?.id;
